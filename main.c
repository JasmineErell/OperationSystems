...
int main(int argc, char** argv) {
    // Validate arguments (queue size + plugin names)
    check_valid_args(argc, argv);

    // If we reach this point, the args are valid.
    // TODO: Proceed to initialize and run your plugin pipeline.
...
// //Argument rules - strats with a number, followed by plugins with spaces between them 
...
//     // Must start with digit 1–9 (no leading zeros, and not 0)
...
//         if (!is_valid_plugin_name(argv[i])) {
//             return 0;
//         }
//     }
